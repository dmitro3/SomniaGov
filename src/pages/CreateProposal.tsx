...
export default function CreateProposal() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Don't show success message here - the hook will show it when transaction is confirmed
      // The hook already shows a loading toast: "Creating proposal... Please wait for confirmation"
      
      // Navigate to proposals list after transaction is submitted
      navigate('/proposals');
    } catch (error) {
